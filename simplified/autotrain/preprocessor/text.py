...
class LLMPreprocessor:
    ...
    def __post_init__(self):
        ...
        if (
            ...
            and self.prompt_column not in self.train_data.columns
        ):
            self.prompt_column = None
        if (
            self.rejected_text_column is not None
            and self.rejected_text_column not in self.train_data.columns
        ):
    ...
    def prepare_columns(self, train_df, valid_df):
        ...
        if self.rejected_text_column is not None:
            ...
            train_df.loc[:, "autotrain_rejected_text"] = train_df[
                self.rejected_text_column
            ]
            valid_df.loc[:, "autotrain_rejected_text"] = valid_df[
                self.rejected_text_column
            ]
